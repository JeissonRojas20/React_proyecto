  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate('/consultaProductoAdmin'); // Redirige a la página de consulta de productos
      } else {
      ...
      <aside className="bg-gray-800 text-white w-64 min-h-screen p-4">
        ...
        <nav>
          <ul className="space-y-2">
            <li>
              <a href="../../bienvenida_administrador.html" className="flex items-center p-2 hover:bg-blue-700 rounded">
                <i className="fas fa-home mr-2"></i>
                Inicio
              </a>
            </li>
            <li>
              <a href="../../consulta_usuarios.html" className="flex items-center p-2 hover:bg-blue-700 rounded">
            ...
            <li>
              <div className="relative">
                ...
                >
                  <a href="/registroProductoAdmin" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                    Agregar Producto
                  </a>
                  <a href="/consultaProductoAdmin" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                    Ver Productos
                  </a>
                </div>
              </div>
