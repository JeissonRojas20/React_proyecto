...
import AlmacenistaActualizarProducto from './actualizar'; // Asegúrate de que la ruta sea correcta
import ConfirmModal from '../../../components/deleteProduct'; // Importa el componente de modal

const AlmacenistaConsultaProducto = () => {
              ...
              <div className="relative">
                ...
                {productDropdownOpen && (
                  <div className="absolute left-0 mt-2 w-full bg-white border border-gray-300 rounded-md shadow-lg">
                    <a
                      href="/registroProductoAlmacenista"
                      className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                    >
                      Agregar producto
                    </a>
                    <a
                      href="/consultaProductoAlmacenista"
                      className="block px-4 py-2 text-gray-700 hover:bg-gray-100"
                    >
                      Ver productos
                    </a>
...
export default AlmacenistaConsultaProducto;
