  ...
  return (
    <div className="font-sans flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            <ul className="flex space-x-4">
              ...
              <li><a href="#productosCajero" className="text-white hover:text-gray-300">Productos</a></li>
      ...
      <section className="p-6 flex-grow">
        <h2 className="text-2xl font-bold mb-6 text-center bg-gray-200 p-3" id='productosCajero'>Nuestros productos</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredProducts.length > 0 ? (
            filteredProducts.map(product => (
              <Link 
                key={product.id} 
                to={`/consultaEspecificaCajero/${product.id}`} 
