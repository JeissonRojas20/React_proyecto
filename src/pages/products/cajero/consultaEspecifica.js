...
const CajeroConsultaEspecifica = () => {
  const { id } = useParams();
  ...
  const handleProductClick = (productId) => {
    navigate(`/consultaEspecificaCajero/${productId}`); // Navega a la pagina en especifico
      ...
      <header className="bg-gray-800 py-4 shadow-md w-full">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="w-1/3 flex justify-start">
            <a href="/" className="text-lg font-bold text-white">Solo Electricos</a>
          </div>
          <nav className="w-1/3 flex justify-center">
            <ul className="flex space-x-4">
              <li><a href="/user/cashier/welcome" className="text-white hover:text-gray-300">Inicio</a></li>
              <li><a href="/consultaProductoCajero" className="text-white hover:text-gray-300">Productos</a></li>
            ...
            <div className="relative">
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg">
                  <a href="./perfil.html" className="block px-4 py-2 text-gray-700 hover:bg-gray-300">Mis datos</a>
              ...
              <div className="data w-full max-w-xl">
                ...
                <div className="flex items-center gap-3">
                  <button className="text-center w-full px-5 py-4 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">
                    ...
                    <span className="pl-3">Agregar a la venta</span>
                  </button>
                </div>
              </div>
            </div>
...
export default CajeroConsultaEspecifica;
